...
languague: english
description: 'Sometimes we believe that is better don’t do the things that we want to do unless we get an optimal way to do it, or rather, until we feel enough prepared, but that is a lie.'
image: '/public/articlesCover/do-it-no-matter.png' 
